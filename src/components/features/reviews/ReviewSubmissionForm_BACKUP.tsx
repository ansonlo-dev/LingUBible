...
import { ReviewSubmissionFormProps, InstructorEvaluation } from './types/ReviewSubmissionForm.types';
...
import { ReviewFormDialogs } from './ReviewFormDialogs';
...
const ReviewSubmissionForm = ({ preselectedCourseCode, editReviewId }: ReviewSubmissionFormProps) => {
  ...
  const state = useReviewFormState(editReviewId);
  const logic = useReviewFormLogic({
    state,
  ...
  const {
    ...
    termsLoading, setTermsLoading,
    instructorsLoading, setInstructorsLoading,
    submitting, setSubmitting,
    loadingEditData, setLoadingEditData,
    courses, setCourses,
    terms, setTerms,
    availableInstructors, setAvailableInstructors,
    instructorsMap, setInstructorsMap,
    instructorCourses, setInstructorCourses,
    teachingRecordsCache, setTeachingRecordsCache,
    termsCache, setTermsCache,
    instructorsCache, setInstructorsCache,
    instructorTeachingRecordsCache, setInstructorTeachingRecordsCache,
    coursesCache, setCoursesCache,
    selectedCourse, setSelectedCourse,
    selectedTerm, setSelectedTerm,
    selectedInstructors, setSelectedInstructors,
    preSelectedInstructor, setPreSelectedInstructor,
    originPage, setOriginPage,
    workload, setWorkload,
    difficulty, setDifficulty,
    usefulness, setUsefulness,
    grade, setGrade,
    courseComments, setCourseComments,
    isAnonymous, setIsAnonymous,
    reviewLanguage, setReviewLanguage,
    previewTimestamp, setPreviewTimestamp,
    instructorEvaluations, setInstructorEvaluations,
    isEditMode, setIsEditMode,
    editingReview, setEditingReview,
    isPopulatingEditData, setIsPopulatingEditData,
    reviewEligibility, setReviewEligibility,
    checkingEligibility, setCheckingEligibility,
    coursePhrasesExpanded, setCoursePhrasesExpanded,
    teachingPhrasesExpanded, setTeachingPhrasesExpanded,
    courseActiveTab, setCourseActiveTab,
    teachingActiveTabs, setTeachingActiveTabs,
    activeInstructorTab, setActiveInstructorTab,
    currentStep, setCurrentStep
  } = state;

  // Destructure logic functions and computed values
  const {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Dialog Components */}
      <ReviewFormDialogs
        showMainExitConfirm={showMainExitConfirm}
        setShowMainExitConfirm={setShowMainExitConfirm}
        onConfirmMainExit={handleConfirmMainExit}
