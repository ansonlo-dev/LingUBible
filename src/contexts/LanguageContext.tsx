...
import { Language } from "@/components/common/LanguageSwitcher";
...
const translations = {
  en: {
    ...
    'oauth.linkBenefits': 'Benefits: Quick login, no need to remember password',
  ...
  'zh-TW': {
    ...
    'privacy.changes.content': '我們可能會不時更新此隱私政策。重大變更將透過網站通知公告。',
            'privacy.contact.title': '8. 聯繫我們',
        'privacy.contact.content': '如果您對此隱私政策有任何疑問或需要行使您的權利，請透過網站聯絡功能與我們聯繫。',
            'privacy.recaptcha.title': '9. reCAPTCHA 保護',
    'privacy.recaptcha.content': '本網站受 reCAPTCHA 保護，適用 Google',
    ...
    'settings.usernamePlaceholder': '輸入您的用戶名（2-10 字符，可留空）',
    ...
    'username.tooShort': '用戶名至少需要 2 個字符',
    'username.tooLong': '用戶名不能超過 10 個字符',
    'username.mustContainValidChars': '用戶名必須包含至少一個中文字符、字母或數字',
    'username.checkError': '檢查用戶名可用性時發生錯誤，請稍後再試',
    'username.available': '用戶名可用',
    'username.lengthError': '用戶名長度必須在 2-10 字符之間',
    'username.invalidParameter': '無效的用戶名參數',
    'username.invalidQuery': '無效的查詢參數',
    'settings.usernameRules': '用戶名規則：',
    'settings.usernameLength': '• 長度：2-10 字符（可留空）',
    'settings.usernameSupported': '• 支援：中文、英文、數字、符號、空格',
    'settings.usernameEmpty': '• 留空時將顯示電子郵件前綴作為用戶名',
    ...
    // Avatar
    'settings.avatar': '頭像',
    'settings.avatarDescription': '自訂您的個人資料頭像',
    'settings.currentAvatar': '目前頭像',
    'settings.customAvatar': '自訂頭像',
    'settings.defaultAvatar': '預設頭像',
    // Change Password
    'settings.changePassword': '變更密碼',
    'settings.password': '密碼',
    'settings.changePasswordDescription': '更新您的帳戶密碼',
    'settings.currentPassword': '目前密碼',
    'settings.currentPasswordPlaceholder': '輸入您的目前密碼',
    'settings.newPassword': '新密碼',
    'settings.newPasswordPlaceholder': '輸入您的新密碼',
    'settings.confirmPassword': '確認新密碼',
    'settings.confirmPasswordPlaceholder': '確認您的新密碼',
    'settings.passwordMismatch': '密碼不一致',
    'settings.passwordSameAsOld': '新密碼不能與目前密碼相同',
    'settings.passwordUpdateSuccess': '密碼更新成功',
    'settings.passwordUpdateFailed': '密碼更新失敗',
    'settings.currentPasswordRequired': '需要輸入目前密碼',
    'settings.newPasswordRequired': '需要輸入新密碼',
    'settings.passwordTooWeak': '新密碼不符合安全要求',
    'settings.wrongCurrentPassword': '目前密碼不正確',
    ...
    'oauth.linkBenefits': '好處：快速登入，無需記住密碼',
  ...
  'zh-CN': {
    ...
    'oauth.linkBenefits': '好处：快速登录，无需记住密码',
