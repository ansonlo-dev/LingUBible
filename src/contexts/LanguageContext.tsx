...
const translations = {
  en: {
    ...
    'oauth.accountAlreadyLinked': 'This Google account is already linked to another user',
  ...
  'zh-TW': {
    ...
    'oauth.accountAlreadyLinked': '此 Google 帳戶已連結到其他用戶',
  ...
  'zh-CN': {
    ...
    'oauth.accountAlreadyLinked': '此 Google 账户已链接到其他用户',
