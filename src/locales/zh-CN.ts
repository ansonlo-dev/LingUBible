export default {
    ...
    'contact.faqDelete': '如何删除我的账户？',
    'contact.faqDeleteAnswer': '请联系我们并提供相关信息，我们会协助您处理账户删除。',
    'contact.faqTechnical': '如何回报技术问题？',
    ...
    'faq.accountAnswer': '您可以使用岭南大学电子邮件地址（@ln.hk或@ln.edu.hk）注册账户。需要先验证学生邮箱，然后设定密码和用户名，注册后可连结Google账户以便更轻松登入。',
    'faq.whyAccountQuestion': '为什么需要创建账户才能提交评论或提问？',
    'faq.whyAccountAnswer': '创建账户有助于维护社群质量和安全性。不过，您可以选择匿名提交评论、问题或答案，我们会保护您的身份隐私，不会向任何第三方透露您的真实身份。',
