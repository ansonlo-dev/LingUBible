export default {
  ...
  'nav.latestReviews': 'Latest Reviews',
  'nav.about': 'About',
  'nav.signIn': 'Sign In',
  ...
  'latestReviews.searchPlaceholder': 'Search course code, title or instructor',
  'latestReviews.matchedCount': '{filtered} matched ({loaded} loaded)',
  'latestReviews.filterHint': 'Filters and sorting apply to loaded reviews only — click "Load More" to include more',
  'latestReviews.sort.newest': 'Newest First',
  'latestReviews.sort.oldest': 'Oldest First',
  'latestReviews.sort.mostUpvoted': 'Most Upvoted',
  'latestReviews.sort.gradeDesc': 'Grade: High to Low',
  'latestReviews.sort.gradeAsc': 'Grade: Low to High',
