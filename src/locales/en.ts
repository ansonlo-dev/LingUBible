export default {
    ...
    'contact.faqDelete': 'How to delete my account?',
    'contact.faqDeleteAnswer': 'Please contact us with relevant information and we will assist you with account deletion.',
    'contact.faqTechnical': 'How to report technical issues?',
    ...
    'faq.accountAnswer': 'You can register for an account using your Lingnan University email address (@ln.hk or @ln.edu.hk). You need to verify your student email first, then set a password and username. Google account linking is available after registration for easier login.',
