export default {
  ...
  'timetable.opt.orientation': 'Orientation',
  'timetable.opt.portrait': 'Portrait',
  'timetable.opt.landscape': 'Landscape',
  'timetable.opt.size': 'Page size',
  'timetable.opt.fitContent': 'Fit content',
  'timetable.opt.fullPage': 'Full page (A4)',
