export default {
  ...
  'auth.passwordTooShort': 'Password must be between 12 and 40 characters long',
  ...
  'auth.usernamePlaceholder': 'Enter your username (2-20 characters)',
  'auth.usernameAvailable': 'Username available',
  'auth.usernameRules': 'Username Rules:',
  'auth.usernameLength': '• Length: 2-20 characters',
  ...
  'password.length': 'Password length 12-40 characters',
  ...
  'auth.useSchoolEmail': 'Please use your school email address (@ln.hk)',
  ...
  'auth.passwordRequirements': 'Password must be 12-40 characters with uppercase, lowercase, number, and special character',
  ...
  'auth.invalidStudentEmail': 'This email address is not a valid Lingnanians email address. Please use a valid @ln.hk email address.',
  ...
  'verification.onlyStudentEmails': 'Only @ln.hk email addresses can register',
  ...
  'settings.usernamePlaceholder': 'Enter your username (2-20 characters, can be empty)',
  ...
  'username.tooLong': 'Username cannot exceed 20 characters',
  ...
  'username.lengthError': 'Username length must be between 2-20 characters',
  ...
  'settings.usernameLength': '• Length: 2-20 characters (can be empty)',
  ...
  'oauth.studentEmailRequired': 'Only students with @ln.hk email addresses can use Google login',
  ...
  'oauth.studentEmailWarningDescription': 'Only students with @ln.hk email addresses can use Google login. Non-student accounts are immediately blocked and deleted by our security system.',
  ...
  'oauth.noLinkedAccountDescription': 'Please register with @ln.hk email first, then link your Google account in settings',
  ...
  'pages.courses.loginForMaterials': 'Some courses offer downloadable study materials — sign in to view them',
  ...
  'filter.hasStudyMaterials': 'Has Study Materials',
  ...
  'pages.courseDetail.pastExamPapers': 'Past Exam Papers',
  'pages.courseDetail.pastExamPapersShort': 'Exams',
  'pages.courseDetail.examPapersSignUpTitle': 'Sign up to view past exam papers',
  'pages.courseDetail.examPapersSignUpDescription': 'Past exam papers are restricted materials available only to verified Lingnan students. Sign up with your Lingnan email to access them.',
  'pages.courseDetail.noExamPapers': 'No past exam papers available yet',
  ...
  'components.pdfViewer.restoringHint': 'Loading your last page and notes — please wait.',
  ...
  'components.pdfViewer.saveDialog.download': 'Download',
  'components.pdfViewer.saveDialog.preparing': 'Preparing…',
  'components.pdfViewer.saveDialog.cancel': 'Cancel',
  ...
  'pages.courseDetail.examPapersSelectAll': 'Select all',
  'pages.courseDetail.examPapersSelectedCount': '{count} selected',
  'pages.courseDetail.examPapersDownloadSelected': 'Download ({count})',
  'pages.courseDetail.examPapersDownloading': 'Preparing…',
  'pages.courseDetail.examPapersDownloadFailed': 'Failed to download exam papers. Please try again.',
  ...
  'pages.courseDetail.basicInfo': 'Basic Information',
  'pages.courseDetail.recommendedStudyYear': 'Recommended Study Year',
  'pages.courseDetail.modeOfTuition': 'Mode of Tuition',
  'pages.courseDetail.classContactHours': 'Class Contact Hours',
  'pages.courseDetail.category': 'Category',
  'pages.courseDetail.discipline': 'Discipline',
  'pages.courseDetail.languageOfInstruction': 'Language of Instruction',
  ...
  'calendar.eventCount': '{count} event',
  'calendar.selectedDay': 'Selected day',
  'calendar.upcoming': 'Upcoming',
  'calendar.legend': 'Legend',
  'calendar.legend.showAll': 'Show all',
  'calendar.legend.toggleHint': 'Click to show/hide this category',
  ...
  'calendar.cat.exam': 'Examinations',
  'calendar.cat.holiday': 'Holiday / Class Suspended',
  ...
  'gpa.classification': 'Classification',
  'gpa.belowHonours': 'Below honours',
  'gpa.gpaCredits': 'GPA credits',
  ...
  'gpa.deansListReq': "≥24 credits in the academic year (with ≥12 credits in one term), a Year GPA of 3.30–3.69, and no F / Fail / U / I grade in any course that year.",
  'gpa.presidentsListReq': "≥24 credits in the academic year (with ≥12 credits in one term), a Year GPA of 3.70 or above, and no F / Fail / U / I grade in any course that year.",
  'gpa.honours.first': 'First',
  'gpa.honours.upperSecond': 'Upper Second',
  'gpa.honours.lowerSecond': 'Lower Second',
  'gpa.honours.third': 'Third',
  'gpa.honours.pass': 'Pass',
  'gpa.honoursFull.first': 'First Class Honours',
  'gpa.honoursFull.upperSecond': 'Upper Second Class Honours',
  'gpa.honoursFull.lowerSecond': 'Lower Second Class Honours',
  'gpa.honoursFull.third': 'Third Class Honours',
  'gpa.honoursFull.pass': 'Pass',
  'gpa.targetTitle': 'Honours & cGPA Target Calculator',
  'gpa.targetDesc': 'Set a target cumulative GPA (or pick an honours class) and we’ll work out the minimum average GPA you need across your remaining credits.',
  'gpa.targetCgpa': 'Target cumulative GPA',
  'gpa.quickSet': 'Quick set',
  'gpa.totalRemainingCredits': 'Total remaining credits',
  'gpa.resultFeasibleLine1': 'To reach a cumulative GPA of {target},',
  'gpa.resultFeasibleLine2': 'in your remaining credits,',
  'gpa.resultFeasibleLine3': 'you need to average at least',
  'gpa.resultAchieved': "You've already secured a cumulative GPA of {target} — as long as you stay enrolled (averaging at least 1.00 each term), it's locked in. 🎉",
  'gpa.resultImpossible': 'A cumulative GPA of {target} is no longer reachable.',
  'gpa.bestPossible': 'Best possible final CGPA: {gpa}',
  ...
  'gpa.yearGpa': 'Year GPA',
  'gpa.creditsShort': '{n} Cred',
  'gpa.removeYear': 'Remove academic year',
  'gpa.addYear': 'Add academic year',
  'gpa.removeTerm': 'Remove term',
  'gpa.addTerm': 'Add term',
  'gpa.colCourse': 'Courses',
  'gpa.colCredits': 'Credits',
  'gpa.colGrade': 'Grade',
  'gpa.coursePlaceholder': 'Select a course',
  'gpa.courseSearchPlaceholder': 'Search by code or name…',
  'gpa.useCustomCode': 'Use "{code}"',
  'gpa.gradePlaceholder': 'Grade',
  'gpa.notGraded': 'Not graded yet',
  'gpa.gpaGrades': 'GPA-bearing',
  'gpa.nonGpaGrades': 'Non-GPA',
  'gpa.removeCourse': 'Remove course',
  ...
  'gpa.honStats.chartTitle': 'First-class Honours Statistics',
  ...
  'timetable.smartSearch': 'CRN / Course / Instructor',
  ...
  'timetable.filter.instructorSearch': 'Search instructor…',
  'timetable.filter.type': 'Type',
  'timetable.filter.allTypes': 'Types',
  'timetable.filter.day': 'Day',
  'timetable.filter.allDays': 'Days',
  'timetable.filter.time': 'Time',
  'timetable.filter.days': 'Days',
  'timetable.filter.timeRange': 'Time range',
  'timetable.filter.timeOff': 'Off',
  'timetable.filter.timeWithin': 'Within',
  'timetable.filter.timeExclude': 'Exclude',
  'timetable.filter.from': 'From',
  'timetable.filter.to': 'To',
  'timetable.filter.timeInvalid': 'End time must be after start time',
  'timetable.filter.clear': 'Clear',
  'timetable.filter.venue': 'Venue',
  'timetable.filter.venueSearch': 'Search building / room',
  'timetable.filter.venueCount': '{count} rooms',
  'timetable.filter.term': 'Terms',
  'timetable.collapsePanel': 'Hide panel',
  'timetable.expandPanel': 'Show panel',
  'timetable.export': 'Export',
  'timetable.cancel': 'Cancel',
  'timetable.exportAnyway': 'Export anyway',
  'timetable.exportConflictTitle': 'Time conflicts detected',
  'timetable.exportConflictDesc': 'Some selected sections overlap in time (highlighted in red). Export anyway?',
  'timetable.editTitle': 'Edit title',
  'timetable.opt.customColor': 'Custom colour',
  'timetable.opt.presetColors': 'Preset colours',
  'timetable.opt.resolution': 'Resolution',
  'timetable.opt.resLow': 'Low',
  'timetable.opt.resStandard': 'Standard',
  'timetable.opt.resHigh': 'High',
  ...
  'timetable.opt.fileType': 'File type',
  'timetable.opt.show': 'Show',
  'timetable.opt.hide': 'Hide',
  'timetable.opt.theme': 'Theme',
  'timetable.opt.light': 'Light',
  'timetable.opt.dark': 'Dark',
  'timetable.opt.title': 'Title',
  'timetable.opt.subGrid': 'Half-hour gridlines',
  'timetable.opt.hours': 'Hours count',
  'timetable.opt.crn': 'CRN',
  'timetable.opt.fCredits': 'Credits',
  'timetable.opt.icons': 'Icons',
  'timetable.opt.timeFormat': 'Time format',
  'timetable.opt.format24': '24-hour',
  'timetable.opt.format12': '12-hour (AM/PM)',
  'timetable.opt.dayFormat': 'Day labels',
  'timetable.opt.firstDay': 'First day',
  'timetable.opt.sunday': 'Sunday',
  'timetable.opt.monday': 'Monday',
  'timetable.opt.days': 'Days',
  'timetable.opt.timeRange': 'Time range',
  'timetable.opt.rangeAuto': 'Auto',
  'timetable.opt.rangeCustom': 'Custom',
  'timetable.opt.fields': 'Show fields',
  'timetable.opt.fCode': 'Course code',
  'timetable.opt.fTitle': 'Course title',
  'timetable.opt.fType': 'Session type',
  'timetable.opt.fNumber': 'Section number',
  'timetable.opt.fVenue': 'Location',
  'timetable.opt.fInstructor': 'Instructor',
  'timetable.opt.fTime': 'Time',
  'timetable.opt.textColor': 'Text colour',
  'timetable.opt.textAuto': 'Auto',
  'timetable.opt.textWhite': 'White',
  'timetable.opt.textBlack': 'Black',
  ...
  'timetable.selectedCount': '{count} selected',
  'timetable.noResults': 'No matching sections.',
  'timetable.sectionLabel': 'Sect {sect}',
  'timetable.noSchedule': 'No scheduled meeting time',
  'timetable.add': 'Add to timetable',
  'timetable.remove': 'Remove',
  'timetable.openCourse': 'Open course page',
  'timetable.openInstructor': 'Open lecturer page',
  'timetable.moreResults': '+{count} more — refine your filters to narrow down.',
  ...
  // Shareable timetable links (?term=…&sections=…)
  'timetable.share.action': 'Share my timetable',
  'timetable.share.cardDesc': '{count} sections · {term}',
  'timetable.share.importTitle': 'Add this shared timetable?',
  'timetable.share.importDesc': 'This link shares {count} sections for {term}. Adding them keeps everything already on your timetable — nothing is removed or replaced.',
  'timetable.share.importRowNew': 'New',
  'timetable.share.importRowExisting': 'Already added',
  'timetable.share.importClashNote': '{count} of them clash with sections you already have. Both are kept and marked in red, so you can decide which to drop.',
  'timetable.share.importMissingNote': '{count} sections in this link are no longer in this term\u2019s data and will be skipped.',
  'timetable.share.importAction': 'Add {count} sections',
  'timetable.share.importActionNone': 'Got it',
  'timetable.share.importEmptyTitle': 'Nothing to add',
  'timetable.share.importEmptyDesc': 'None of the sections in this shared link exist in {term} any more.',
  'timetable.share.importAlreadyTitle': 'Already on your timetable',
  'timetable.share.importAlreadyDesc': 'Every section in this shared link has already been added.',
  'timetable.share.importedTitle': 'Added {count} sections',
  'timetable.share.importedKept': 'Your existing sections were kept.',
  'timetable.share.importedClashes': '{count} clash with your existing sections (marked in red).',
  'timetable.share.importedSkipped': '{count} were already on your timetable.',
  'timetable.share.importedMissing': '{count} were skipped (no longer offered).',
  ...
  'share.messengerCopied': 'Link copied for Messenger',
  'share.messengerCopiedDescription': 'Messenger has no web share link — paste it into a chat.',
  ...
  'share.text.timetable': 'Here is my {term} timetable on LingUBible — open the link to load it next to your own.',
  ...
  'filter.clickToFilterRequirementHas': 'Click to filter by requirement: Have {requirement}',
  'filter.clickToFilterRequirementNo': 'Click to filter by requirement: No {requirement}',
  ...
  'faq.accountAnswer': 'You can register for an account using your Lingnan University email address (@ln.hk). You need to verify your student email first, then set a password and username. After registration, you can link your Google account for easier login.',
  ...
  'donate.coin.btc': 'Bitcoin',
  'donate.coin.eth': 'Ethereum',
  'donate.coin.usdt-erc20': 'Tether',
  'donate.coin.usdt-trc20': 'Tether',
  'donate.coin.sol': 'Solana',
  'donate.coin.trx': 'Tron',
  'donate.coin.gram': 'Gram',
  'donate.coin.bnb': 'Binance Coin',
  'donate.coin.doge': 'Dogecoin',
  'donate.coin.xrp': 'Ripple',
  'donate.coin.ltc': 'Litecoin',
  'donate.coin.zec': 'Zcash',
  'donate.footnote': 'Thanks for using LingUBible ❤️',
  'donate.copied': 'Address copied',
  'donate.copiedDescription': 'The {name} address has been copied to your clipboard.',
  'donate.copyFailed': 'Copy failed',
  'donate.copyFailedDescription': 'Please select and copy the address manually.',
  'donate.copyAddress': 'Copy {name} address',
  'donate.afterReview': 'Enjoying LingUBible? Buy me a coffee',
  ...
  'loading.progress.text': 'Loading {label} ({current}/{total})',
  'loading.progress.step.courses': 'courses',
  'loading.progress.step.instructors': 'instructors',
  'loading.progress.step.reviews': 'reviews',
  'loading.progress.step.stats': 'statistics',
  'loading.progress.step.cache': 'cache',
  'common.error': 'Error',
  'common.success': 'Success',
  'common.cancel': 'Cancel',
  'loginRequired.title': 'Login required',
  'loginRequired.description': 'This feature is available only to verified Lingnan students. Please log in or sign up with your Lingnan email to continue.',
  ...
  'review.cannotDeselectPreSelectedInstructor': 'You must keep {instructor} selected for at least one session (Lecture or Tutorial)',
  ...
  'review.notAttended': 'Did not attend',
  'review.notAttendedDescription': 'Did not attend this instructor\'s classes, so teaching is not rated',
  'review.optionalField': 'Optional',
  'review.instructorsOptionalHint': 'You can review the course only and skip instructors for now — add instructor reviews anytime later by editing in "My Reviews".',
  'review.noInstructorEvaluationsNotice': 'This review does not include instructor evaluations. You can add them anytime later by editing in "My Reviews".',
  'review.draftRestored': 'Restored your unsubmitted draft',
  'review.discardDraft': 'Discard draft',
  ...
  'review.exitConfirmDescription': 'Your review progress has been auto-saved as a draft — you can pick up where you left off next time.',
  // Formatting toolbar
  ...
  'latestReviews.loadError': 'Failed to load reviews. Please try again later.',
  'latestReviews.submitHintPrefix': 'Want to submit a review? Go to the ',
  'latestReviews.submitHintCourse': 'course info page',
  'latestReviews.submitHintMiddle': ' or ',
  'latestReviews.submitHintInstructor': 'instructor info page',
  'latestReviews.submitHintSuffix': ' to write one.',
  'latestReviews.retry': 'Retry',
  ...
  'myReviews.noInstructorEvaluations': 'This review does not include instructor evaluations yet',
  'myReviews.addInstructorEvaluation': 'Add instructor review',
  // Featured content
  ...
  'changelog.subtitle': 'Every update to LingUBible worth knowing about, newest first.',
  'changelog.meta': '{count} updates · last updated {date}',
  'changelog.filters': 'Filters',
  'changelog.filter.all': 'All',
  'changelog.type.feature': 'New feature',
  'changelog.type.improvement': 'Improvement',
  'changelog.type.fix': 'Bug fix',
  'changelog.type.performance': 'Performance',
  'changelog.type.data': 'Data update',
  'changelog.type.security': 'Security & privacy',
  'changelog.range.label': 'Period',
  'changelog.range.all': 'All time',
  'changelog.range.30d': 'Last 30 days',
  'changelog.range.90d': 'Last 90 days',
  'changelog.range.365d': 'Last year',
  'changelog.range.custom': 'Custom',
  'changelog.range.from': 'From',
  'changelog.range.to': 'To',
  'changelog.sort.newest': 'Newest first',
  'changelog.sort.oldest': 'Oldest first',
  'changelog.reset': 'Reset',
  'changelog.showing': 'Showing {count} of {total} updates',
  'changelog.empty.title': 'No updates match these filters',
  'changelog.empty.desc': 'Try a different type or a wider date range.',
  'changelog.note': 'This is a curated list — purely technical and internal changes are left out.',
  'changelog.viewCommits': 'Full commit history on GitHub',
  'share.text.changelog': "See what's new on LingUBible — the full changelog of features, fixes and data updates.",
  // =============================================================================
  ...
  'gettingStarted.readCount': '{read}/{total} read',
  'gettingStarted.prev': 'Back',
  'gettingStarted.next': 'Next',
  'gettingStarted.finish': "Done \u2014 let's go",
  'gettingStarted.later': 'Maybe later',
  'gettingStarted.openFullPage': 'Open the full page',
  'gettingStarted.link.writeReview': 'Write a review',
  'gettingStarted.done.title': "You're all set!",
  'gettingStarted.done.desc': 'Reopen this guide any time from the sidebar or the footer.',
  'gettingStarted.done.browse': 'Browse courses',
  'gettingStarted.done.faq': 'Read the FAQ',
  'gettingStarted.done.replay': 'Play again',

  'gettingStarted.step.welcome.pill': 'Welcome',
  'gettingStarted.step.welcome.title': 'What LingUBible is',
  'gettingStarted.step.welcome.tagline': 'A course-picking platform built by Lingnan students, for Lingnan students. Good decisions start with good information.',
  'gettingStarted.step.welcome.p1': 'One search box covers course codes, titles and instructor names.',
  'gettingStarted.step.welcome.p2': 'Reviews, syllabi and the academic calendar are free to read \u2014 no sign-in needed.',
  'gettingStarted.step.welcome.p3': 'Sign up with your @ln.hk email to write reviews, open past papers and save favourites.',

  'gettingStarted.step.reviews.pill': 'Reviews',
  'gettingStarted.step.reviews.title': 'Course & instructor reviews',
  'gettingStarted.step.reviews.tagline': 'See what classmates actually experienced before you enrol \u2014 workload, difficulty and usefulness at a glance.',
  'gettingStarted.step.reviews.p1': 'Every course carries three ratings: workload, difficulty and usefulness. Green is the better end.',
  'gettingStarted.step.reviews.p2': 'Grade distributions show the marks students really got, not just star ratings.',
  'gettingStarted.step.reviews.p3': 'Filter and sort by department, term, teaching language, required/elective and more.',
  ...
  'gettingStarted.step.planner.tagline': 'Pick sections and preview your week live, so clashes and gaps show up before add/drop closes.',
  'gettingStarted.step.planner.p1': 'Search sections by CRN, course or instructor and add them with one tap.',
  'gettingStarted.step.planner.p2': 'Clashes are flagged instantly, and you can filter by day and time range.',
  'gettingStarted.step.planner.p3': 'Share your timetable as a link — friends can load your sections alongside their own without losing anything they picked.',

  'gettingStarted.step.gpa.pill': 'GPA',
  'gettingStarted.step.gpa.title': 'GPA & honours calculator',
  'gettingStarted.step.gpa.tagline': 'Work out your GPA instantly and see which honours classification it lands in.',
  'gettingStarted.step.gpa.p1': 'Enter courses and grades to get both your term GPA and cumulative GPA.',
  'gettingStarted.step.gpa.p2': "Your result is matched against Lingnan's honours bands automatically.",
  'gettingStarted.step.gpa.p3': 'First Class stats show how common a first has been in each programme.',

  'gettingStarted.step.calendar.pill': 'Calendar',
  'gettingStarted.step.calendar.title': 'Academic calendar',
  'gettingStarted.step.calendar.tagline': 'Term start, exams, add/drop and holidays \u2014 all on one page.',
  'gettingStarted.step.calendar.p1': 'Switch between day, week and month views, or jump to the start of term.',
  'gettingStarted.step.calendar.p2': 'Events are colour-coded by category, and every category can be toggled off.',
  'gettingStarted.step.calendar.p3': 'Spot the deadlines that matter without digging through university pages.',

  'gettingStarted.step.contribute.pill': 'Contribute',
  'gettingStarted.step.contribute.title': 'Write reviews & make it yours',
  'gettingStarted.step.contribute.tagline': 'One review from you is what next year\u2019s cohort will pick their courses on.',
  'gettingStarted.step.contribute.p1': 'A step-by-step form walks you through the ratings and comments, saving a draft as you go.',
  'gettingStarted.step.contribute.p2': 'Reviews are anonymous by default, with Markdown formatting and a live preview.',
  'gettingStarted.step.contribute.p3': 'Favourite courses and instructors, and switch language or dark mode any time.',

  'share.text.gettingStarted': 'New to LingUBible? This one-minute guide covers course reviews, past papers, the lesson planner and the GPA calculator.',
};