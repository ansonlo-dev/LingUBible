export default {
  ...
  'donate.description': 'LingUBible is free and open source, and always will be. If it saved you some time, you can buy the developer a coffee — entirely optional, and nothing is locked behind it.',
  'donate.kofiHint': 'One-off or monthly, card or PayPal',
  'donate.cryptoTitle': 'Crypto',
  'donate.cryptoHint': 'Tap an address to copy it.',
  'donate.footnote': 'Thanks for using LingUBible 💚',
