export default {
  ...
  'gpa.resultImpossible': '{target} is no longer reachable, even with a perfect 4.00 in every remaining credit.',
  ...
  'gpa.academicYear': 'Academic Year {n}',
  'gpa.yearNameLabel': 'Academic year name',
  ...
  'gpa.partShort.term1': 'T1',
  'gpa.partShort.term2': 'T2',
  'gpa.partShort.summer': 'Su',
  'gpa.partShort.other': 'Ot',
