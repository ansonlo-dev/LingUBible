export default {
  ...
  'gpa.honours.first': 'First Class',
  'gpa.honours.upperSecond': 'Upper Second',
  'gpa.honours.lowerSecond': 'Lower Second',
  'gpa.honours.third': 'Third Class',
  'gpa.honours.pass': 'Pass',
  'gpa.targetTitle': 'Honours Target Calculator',
  'gpa.targetDesc': 'Find the minimum average GPA you need across your remaining terms to graduate with a target classification, based on your current results.',
  'gpa.targetClass': 'Target classification',
  'gpa.totalRemainingCredits': 'Total remaining credits',
  'gpa.totalRemainingCreditsHint': 'Default: {terms} remaining terms × 15 = {n} credits. Edit if needed.',
  'gpa.resultFeasiblePrefix': 'To graduate with {target}, you need to average at least',
  'gpa.perRemainingCredit': 'across your remaining credits',
  'gpa.resultAchieved': "You've already secured {target} — as long as you stay enrolled (averaging at least 1.00 each term), it's locked in. 🎉",
  'gpa.resultImpossible': '{target} is no longer reachable.',
  'gpa.bestPossible': 'Best possible final CGPA: {gpa}',
  'gpa.resultNoRemaining': 'With no remaining credits, your final CGPA is {gpa}, which falls short of {target}.',
  ...
  'gpa.part.term1': 'Term 1',
  'gpa.part.term2': 'Term 2',
  'gpa.part.summer': 'Summer',
  'gpa.part.other': 'Other',
