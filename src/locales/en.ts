export default {
  ...
  // zh 版句式為「開源工具構建 ansonlo.dev 開發」，英文句子已含 "by"，
  // Footer 也只在 zh 語系渲染這個字尾 —— 保留空字串以維持三語鍵一致。
  'footer.developedBy': '',
  ...
  // Password reset results (send-verification-email function)
  'password.resetSent': 'If an account with this email exists, a password reset link has been sent',
  'password.rateLimitExceeded': 'Too many password reset requests. Please try again in {remainingMinutes} minutes',
  'password.tooShort': 'Password must be at least 12 characters long',
  'password.invalidToken': 'Reset link is invalid or has expired',
  'password.tokenExpired': 'This reset link has expired, please request a new one',
  'password.tokenValid': 'Reset link is valid',
  'password.linkAlreadyUsed': 'This reset link has already been used, please request a new one',
  'password.resetSuccess': 'Password reset successfully',
  'password.updateFailed': 'Failed to update password, please try again later',
  ...
  // Backend messageKeys returned by the send-verification-email function
  'verification.codeNotFound': 'No verification code found for this email address',
  'verification.codeExpired': 'Verification code has expired, please request a new one',
  'verification.tooManyAttempts': 'Too many verification attempts, please request a new code',
  'verification.invalidCode': 'Incorrect verification code. {remainingAttempts} attempts remaining',
  'verification.emailNotVerified': 'This email address has not been verified yet',
  'verification.verificationExpired': 'Email verification has expired, please verify again',
  'verification.success': 'Lingnanians email verified! You can now set your password to complete registration.',
  ...
  // Account creation results (send-verification-email function)
  'account.createSuccess': 'Account created successfully',
  'account.emailExists': 'An account with this email address already exists',
  'account.createFailed': 'Account creation failed, please try again later',
  ...
  'pages.courseDetail.readings': 'Readings',
  'pages.courseDetail.readingsShort': 'Readings',
  ...
  'pages.courseDetail.readingsHint': 'Reading lists are taken from the course syllabus. Books and articles open a search on Anna’s Archive; websites open the original page.',
  'pages.courseDetail.readingKindBook': 'Books',
  'pages.courseDetail.readingKindArticle': 'Articles / Thesis',
  'pages.courseDetail.readingKindWebsite': 'Websites',
  'pages.courseDetail.readingOpenWebsite': 'Open website',
  'pages.courseDetail.readingSearchArchive': 'Find on Anna’s Archive',
  'pages.courseDetail.noReadings': 'No readings available yet',
  ...
  'instructors.nameNotProvided': 'Lecturer name not provided',
  'instructors.loadError': 'An error occurred while loading lecturer data',
  ...
  'error.recaptchaFailed': 'reCAPTCHA verification failed, please try again',
  ...
  'review.voteError': 'Vote failed, please try again.',
