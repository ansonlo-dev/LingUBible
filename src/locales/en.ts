export default {
  ...
  'gpa.resultAchieved': "You've already secured {target} — it's locked in regardless of your remaining results. 🎉",
  ...
  'gpa.reset': 'Reset',
  'gpa.resetConfirmTitle': 'Reset all terms?',
  'gpa.resetConfirmDesc': 'This clears every course and grade you entered and restores the default 8 terms. This cannot be undone.',
  'gpa.removeTerm': 'Remove term',
  'gpa.colCourse': 'Course code',
  'gpa.colCredits': 'Credits',
  'gpa.colGrade': 'Grade',
  'gpa.codePlaceholder': 'e.g. BUS1102',
  ...
  'gpa.defaultTermLabel': 'Y{year}T{part}',
  'gpa.newTermLabel': 'Term {n}',
  'gpa.disclaimer': 'For reference only. Credits are looked up from the course catalog; always verify against your official transcript and your programme’s honours regulations.',
  // Timetable planner
