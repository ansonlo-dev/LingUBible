export default {
  ...
  'gpa.honStats.trendNote': '2013: {y2013} → 2024: {y2024}',
  'gpa.honStats.vsPrev': '2024: {value}',
  'gpa.honStats.chartTitle': 'First-class share by programme (2024 vs 2025)',
  'gpa.honStats.metricRate': 'First-class rate',
  'gpa.honStats.metricFirst': 'First-class grads',
  'gpa.honStats.metricTotal': 'Total grads',
  'gpa.honStats.uniAvg': 'University average ({value})',
  'gpa.honStats.tipRate': 'First-class rate',
  'gpa.honStats.tipFirst': 'First-class grads',
  'gpa.honStats.tipTotal': 'Total grads',
  'gpa.honStats.source': 'Source: Lingnan University graduate lists. 2025 is the latest cohort; 2024 shown for comparison.',
  // Timetable planner
