export default {
  ...
  'playStore.beta': 'BETA',
  'playStore.dialogTitle': 'Install the Android App (Beta)',
  'playStore.dialogIntro': 'Due to Google Play\'s new testing policy, you need to be invited as a tester before you can download the app. Please follow these steps in order:',
  'playStore.step1Title': 'Join the Google Group',
  'playStore.step1Desc': 'Join with the Gmail account you will use for testing.',
  'playStore.step2Title': 'Register as a tester',
  'playStore.step2Desc': 'After joining the group, sign in with the same Gmail account and opt in as a tester.',
  'playStore.step3Title': 'Download from Google Play',
  'playStore.step3Desc': 'Once you are a tester, follow the link below to Google Play, download the app and start exploring.',
  'playStore.step4Title': 'Keep the app for at least 14 days',
  'playStore.step4Desc': 'Please keep the app installed for at least 14 days to help us meet Google Play\'s testing requirement.',
  'playStore.feedback': 'The current version is still being improved. If you run into any bugs, UI layout issues, or have suggestions, feel free to leave a review on the Play Store or report to us at',
  ...
  'beta.notice.spreadsheetPrompt': 'If needed,',
  'beta.notice.spreadsheetLinkText': 'view ALL reviews',
