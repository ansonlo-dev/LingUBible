export default {
  ...
  'background.aurora': '極光綠',
  'background.cosmic': '宇宙紫',
  'background.tropical': '熱帶橙',
  'background.fire': '火焰紅',
  'background.ice': '冰雪藍',
  ...
  'background.sand': '沙灘色',
  'background.linen': '亞麻色',
  'background.opal': '蛋白彩',
  'background.burgundy': '酒紅色',
  'background.maroon': '栗紅色',
  'background.crimson': '緋紅色',
  'background.rust': '鐵鏽色',
  'background.copper': '古銅色',
  'background.bronze': '青銅色',
  'background.navy': '海軍藍',
