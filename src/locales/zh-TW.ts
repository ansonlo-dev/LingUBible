export default {
  ...
  'gpa.honStats.chartTitle': '各課程一級榮譽比例(2024 對比 2025)',
  'gpa.honStats.metricRate': '一級榮譽比例',
  'gpa.honStats.metricFirst': '一級榮譽人數',
  'gpa.honStats.metricTotal': '畢業生人數',
  'gpa.honStats.uniAvg': '全校平均({value})',
  'gpa.honStats.tipRate': '一級榮譽比例',
  'gpa.honStats.tipFirst': '一級榮譽人數',
  'gpa.honStats.tipTotal': '畢業生人數',
  'gpa.honStats.source': '資料來源:嶺南大學畢業生名單。2025 為最新一屆,2024 供對比參考。',
  // 時間表規劃工具
