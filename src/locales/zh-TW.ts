export default {
  ...
  'gpa.honours.first': '一級榮譽',
  'gpa.honours.upperSecond': '二級甲等榮譽',
  'gpa.honours.lowerSecond': '二級乙等榮譽',
  'gpa.honours.third': '三級榮譽',
  'gpa.honours.pass': '及格',
  'gpa.targetTitle': '榮譽目標計算器',
  'gpa.targetDesc': '根據你目前的成績,計算餘下學期需要的最低平均 GPA,以達成目標榮譽等級畢業。',
  'gpa.targetClass': '目標榮譽等級',
  'gpa.totalRemainingCredits': '餘下總學分',
  'gpa.totalRemainingCreditsHint': '預設:餘下 {terms} 個學期 × 15 = {n} 學分,需要時可自行修改。',
  'gpa.resultFeasiblePrefix': '要以{target}畢業,你餘下學分的平均 GPA 至少需要',
  'gpa.perRemainingCredit': '(以餘下學分計算)',
  'gpa.resultAchieved': '你已穩奪{target}——只要維持學籍(每學期平均不低於 1.00),便已鎖定。🎉',
  'gpa.resultImpossible': '已無法達到{target}。',
