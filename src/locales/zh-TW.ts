export default {
  ...
  'latestReviews.searchPlaceholder': '搜尋課程代碼、課程名稱或講師',
  'latestReviews.matchedCount': '符合條件 {filtered} 筆（已載入 {loaded} 筆）',
  'latestReviews.filterHint': '篩選與排序僅套用於已載入的評論，點「載入更多」可納入更多評論',
  'latestReviews.sort.newest': '最新優先',
  'latestReviews.sort.oldest': '最舊優先',
  'latestReviews.sort.mostUpvoted': '最多讚',
  'latestReviews.sort.gradeDesc': '成績：高至低',
  'latestReviews.sort.gradeAsc': '成績：低至高',
