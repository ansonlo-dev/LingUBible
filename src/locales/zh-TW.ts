export default {
  ...
  'donate.description': 'LingUBible 完全免費、開源。如果它幫你省下了一些時間，可以請開發者喝杯咖啡——捐款會用來支付營運開銷（伺服器、資料庫、網域等）。純屬自願，不會有任何功能被鎖住。',
  'donate.kofiHint': '單次或每月贊助，支援信用卡與 PayPal',
  'donate.cryptoTitle': '加密貨幣',
  'donate.cryptoHint': '點一下地址即可複製，或點右邊的圖示顯示 QR 碼。',
