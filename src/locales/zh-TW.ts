export default {
  ...
  'background.blush': '胭脂',
  'background.cherry': '櫻桃',
  'background.salmon': '鮭魚',
  'background.powder': '粉藍',
  'background.seafoam': '海泡',
  'background.aqua': '水藍',
  'background.jade': '翡翠',
  'background.turquoise': '土耳其藍',
  'background.sage': '鼠尾草',
  'background.lilac': '紫丁香',
  'background.orchid': '蘭花',
  'background.mauve': '淡紫',
  'background.pearl': '珍珠',
  'background.ivory': '象牙',
  'background.sand': '沙灘',
  'background.linen': '亞麻',
  'background.opal': '蛋白石',
  'background.burgundy': '酒紅',
  'background.maroon': '栗色',
  'background.crimson': '緋紅',
  'background.rust': '鐵鏽',
