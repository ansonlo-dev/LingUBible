export default {
  ...
  'playStore.beta': 'BETA',
  'playStore.dialogTitle': '安裝 Android 應用程式（Beta）',
  'playStore.dialogIntro': '由於 Google Play 新規限制，需要邀請測試員加入才能下載，麻煩請依序操作：',
  'playStore.step1Title': '加入 Google 群組',
  'playStore.step1Desc': '用你要測試的 Gmail 帳號加入群組。',
  'playStore.step2Title': '登記成為測試人員',
  'playStore.step2Desc': '加入群組後，登入同一個 Gmail 帳號並登記為測試人員。',
  'playStore.step3Title': '前往 Google Play 下載',
  'playStore.step3Desc': '成為測試人員後，點下方連結前往 Google Play 下載並開始體驗。',
  'playStore.step4Title': '保留應用程式至少 14 天',
  'playStore.step4Desc': '請將應用程式保留安裝至少 14 天，以符合 Google Play 的測試要求。',
  'playStore.feedback': '目前版本仍在持續優化中，如果在使用上遇到任何 Bug、UI 排版問題或改善建議，非常歡迎在 Play Store 上留言或回報給我們：',
