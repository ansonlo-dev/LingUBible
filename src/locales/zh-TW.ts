export default {
  ...
  'gpa.resultAchieved': '你已穩奪{target}——無論餘下成績如何也不會改變。🎉',
  ...
  'gpa.termsTitle': '你的學期',
  'gpa.reset': '重設',
  'gpa.resetConfirmTitle': '重設所有學期?',
  'gpa.resetConfirmDesc': '這會清除你輸入的所有課程與成績,並還原為預設的 8 個學期。此動作無法復原。',
  'gpa.removeTerm': '移除學期',
  'gpa.colCourse': '課程編號',
  'gpa.colCredits': '學分',
  'gpa.colGrade': '成績',
  ...
  'gpa.newTermLabel': '學期 {n}',
  'gpa.disclaimer': '僅供參考。學分取自課程目錄,請務必對照正式成績單及你所屬課程的榮譽等級規例核實。',
  // 時間表規劃工具
