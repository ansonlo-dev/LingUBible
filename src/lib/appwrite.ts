import { Client, Account, Databases, TablesDB, Functions, Storage, ID } from 'appwrite';

// 使用環境變量來管理不同環境的端點
// 現在使用已驗證的自定義域名，這將消除 localStorage 警告
const APPWRITE_ENDPOINT = import.meta.env.VITE_APPWRITE_ENDPOINT || 'https://appwrite.lingubible.com/v1';
