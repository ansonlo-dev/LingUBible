                    ...
                    <div className="flex flex-col gap-2 min-w-0 flex-1">
                      ...
                      <div className="flex gap-2 mt-1 flex-wrap md:hidden max-w-[calc(100%-3rem)]">
                        <ResponsiveTooltip
                          ...
                          clickActionText={t('tooltip.clickAgainToFilter')}
                          onFirstTap={() => {
                            console.log('📅 Term Badge (Instructors): First tap - setting pending filter');
                            setPendingTermFilter(reviewInfo.term.term_code);
                          }}
                          onSecondTap={() => {
                            console.log('✅ Term Badge (Instructors): Second tap - applying filter');
                            setPendingTermFilter(null);
                            handleFiltersChange({
                              ...filters,
                        ...
                        {reviewInfo.review.review_language && (
                          <ResponsiveTooltip
                            ...
                            clickActionText={t('tooltip.clickAgainToFilter')}
                            onFirstTap={() => {
                              console.log('🌐 Review Language Badge (Instructors): First tap - setting pending filter');
                              setPendingReviewLanguageFilter(reviewInfo.review.review_language!);
                            }}
                            onSecondTap={() => {
                              console.log('✅ Review Language Badge (Instructors): Second tap - applying filter');
                              setPendingReviewLanguageFilter(null);
                              handleFiltersChange({
                                ...filters,
                      ...
                      <div className="hidden md:flex items-center gap-2 shrink-0">
                        ...
                        {reviewInfo.review.review_language && (
                          <ResponsiveTooltip
                            ...
                            clickActionText={t('tooltip.clickAgainToFilter')}
                            onFirstTap={() => {
                              console.log('📅 Language Badge (Instructors): First tap - setting pending filter');
                              setPendingReviewLanguageFilter(reviewInfo.review.review_language || 'en');
                            }}
                            onSecondTap={() => {
                              console.log('✅ Language Badge (Instructors): Second tap - applying filter');
                              setPendingReviewLanguageFilter(null);
                              handleFiltersChange({
                                ...filters,
                      ...
                      {reviewInfo.review.course_final_grade && (
                        <div className="flex flex-col items-center shrink-0">
                          ...
                          onFirstTap={() => {
                            ...
                            console.log('🔄 Instructors.tsx: First tap - setting pending filter');
                            setPendingGradeFilter(normalizedGrade);
                          }}
                          onSecondTap={() => {
                            console.log('✅ Instructors.tsx: Second tap - clearing pending filter');
                            setPendingGradeFilter(null);
                          }}
                          onClick={() => {
                            const normalizedGrade = reviewInfo.review.course_final_grade === '-1' ? 'N/A' : reviewInfo.review.course_final_grade;
                            console.log('🚀 Instructors.tsx: Applying grade filter');
                            setFilters(prev => ({
                              ...prev,
                                ...
                                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2 md:gap-4">
                                  ...
                                  <div className="hidden md:flex md:items-start md:gap-2 md:shrink-0">
                                    ...
                                    <ResponsiveTooltip
                                      ...
                                      clickActionText={t('tooltip.clickAgainToFilter')}
                                      onFirstTap={() => {
                                        console.log('📚 Session Type Badge (Instructors): First tap - setting pending filter');
                                        setPendingSessionTypeFilter(currentInstructorDetail.session_type);
                                      }}
                                      onSecondTap={() => {
                                        console.log('✅ Session Type Badge (Instructors): Second tap - applying filter');
                                        const newFilters = { ...filters };
                                        const sessionType = currentInstructorDetail.session_type;
                                  ...
                                  <div className="ml-4 space-y-2">
                                    <div className="flex items-center gap-2">
                                      <ResponsiveTooltip
                                        ...
                                        clickActionText={t('tooltip.clickAgainToFilter')}
                                        onFirstTap={() => {
                                          console.log('📋 Service Learning Badge (Instructors): First tap - setting pending filter');
                                          setPendingServiceLearningFilter(currentInstructorDetail.service_learning_type);
                                        }}
                                        onSecondTap={() => {
                                          console.log('✅ Service Learning Badge (Instructors): Second tap - applying filter');
                                          setPendingServiceLearningFilter(null);
                                          handleFiltersChange({
                                            ...filters,
                                        ...
                                        <div className="ml-4 space-y-2">
                                          <div className="flex items-center gap-2">
                                            <ResponsiveTooltip
                                              ...
                                              clickActionText={t('tooltip.clickAgainToFilter')}
                                              onFirstTap={() => {
                                                console.log('📋 Service Learning Badge (Instructors Other): First tap - setting pending filter');
                                                setPendingServiceLearningFilter(instructor.service_learning_type);
                                              }}
                                              onSecondTap={() => {
                                                console.log('✅ Service Learning Badge (Instructors Other): Second tap - applying filter');
                                                setPendingServiceLearningFilter(null);
                                                handleFiltersChange({
                                                  ...filters,
