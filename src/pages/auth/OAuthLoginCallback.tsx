          ...
          if (!isStudentEmail) {
            ...
            try {
              ...
              try {
                ...
                const validationResponse = await fetch(`${import.meta.env.VITE_APPWRITE_ENDPOINT}/functions/user-validation/executions`, {
                  method: 'POST',
                  headers: {
              ...
              try {
                ...
                const cleanupResponse = await fetch(`${import.meta.env.VITE_APPWRITE_ENDPOINT}/functions/cleanup-expired-codes/executions`, {
                  method: 'POST',
                  headers: {
                    'Content-Type': 'application/json',
                    'X-Appwrite-Project': '6a1097400037a55f6472',
